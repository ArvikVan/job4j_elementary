...
/*В методе main создайте дополнительные переменные, кроме тех, что уже созданы.
...
public class Calculator {
    public static void main(String[] args) {
        ...
        System.out.println("sixDivTwo = six / two = " + sixDivTwo);
        System.out.println("fiveMinusTwo = five - two = " + fiveMinusTwo);
        System.out.println("fourTimeTwo = four * two = " + fourTimeTwo);
        System.out.println("onePlusTwo = one + two = " + onePlusTwo);
    }
}
